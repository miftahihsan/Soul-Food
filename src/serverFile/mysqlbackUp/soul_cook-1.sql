...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2018 at 01:40 PM
...
--
-- Table structure for table `confirmed_purchase`
--

CREATE TABLE `confirmed_purchase` (
...
--
-- Dumping data for table `confirmed_purchase`
--

INSERT INTO `confirmed_purchase` (`cart_id`, `post_id`, `user_id`, `quantity`, `discount`, `unit_price`, `order_status`, `order_placed_date`) VALUES
(13, 8, 'user_3', 3, 5, 500, 0, '2018-11-27 11:32:33'),
(14, 14, 'user_4', 5, 0, 1000, 0, '2018-11-27 11:32:47'),
(15, 8, 'user_4', 10, 5, 500, 0, '2018-11-27 11:32:44');
...
--
-- Table structure for table `cook_history`
--
...
INSERT INTO `user_cart` (`cart_id`, `date`, `item`, `quantity`, `unit_price`, `discount`, `user_id`, `post_id`, `purchased`) VALUES
(13, '2018-11-27 11:32:33', 'Pizza', 3, 500, 5, 'user_3', 8, 1),
(14, '2018-11-27 11:32:46', 'Dark Forest', 5, 1000, 0, 'user_4', 14, 1),
(15, '2018-11-27 11:32:44', 'Pizza', 10, 500, 5, 'user_4', 8, 1);
...
--
-- Indexes for table `confirmed_purchase`
--
ALTER TABLE `confirmed_purchase`
...
--
-- Indexes for table `cook_history`
--
...
--
-- AUTO_INCREMENT for table `cook_history`
--
ALTER TABLE `cook_history`
...
--
-- Constraints for table `confirmed_purchase`
--
ALTER TABLE `confirmed_purchase`
  ADD CONSTRAINT `confirmed_purchase_ibfk_1` FOREIGN KEY (`cart_id`) REFERENCES `user_cart` (`cart_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `confirmed_purchase_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `cook_post` (`post_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `confirmed_purchase_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `helper_table_user` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `user_cart`
  ADD CONSTRAINT `user_cart_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `cook_post` (`post_id`),
  ADD CONSTRAINT `user_cart_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `helper_table_user` (`user_id`);
